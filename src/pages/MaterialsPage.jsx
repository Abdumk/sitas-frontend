...
//   useEffect(() => {
//     fetchProjects();
//     fetchMaterialsCatalog(); // Fetch all material types
//     fetchInventory(); // Fetch project inventory data
//   }, []);
...
//     // Correct endpoint for fetching all materials
//     axios
...
//   //     // Correct endpoint for fetching project inventory
//   //     axios.get('http://localhost:5000/api/inventory', { headers: { Authorization: `Bearer ${token}` } })
//   //         .then(res => setInventory(res.data))
//   //         .catch(err => console.error("Error fetching inventory:", err));
//   // };
//   const fetchInventory = () => {
//     const url = `http://localhost:5000/api/inventory?t=${Date.now()}`; // ✅ Cache bust
//     axios
//       .get(url, { headers: { Authorization: `Bearer ${token}` } })
//       .then((res) => {
//         console.log("🔁 Fetched updated inventory:", res.data);
...
//       // Parse as integer, but keep as 0 or empty string
...
//   // Handler for the Material Catalog Form
...
//   // Handler for the Project Inventory Form
 
// // ✅ Submit handler: decide POST vs PUT
...
//  // ✅ Editing: store only IDs (not full objects)
...
//     }
//   };
// // ✅ Fix filter to work with either populated or raw materialId
...
//           </tr>
//         </thead>
//         {/* // In MaterialsPage.js, find the inventory table body */}
//    <tbody>
//   {filteredInventory.length > 0 ? (
//     filteredInventory.map((item) => {
//       // ✅ Handle populated OR raw
//       const project =
